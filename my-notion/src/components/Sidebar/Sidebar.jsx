        ...
        <>
            ...
            <aside className="sidebar">
                ...
                <nav className="sidebar-nav">
                    ...
                    <button className="sidebar-nav-item" onClick={() => navigate('/timetable')}>
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2" /><line x1="3" y1="10" x2="21" y2="10" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="16" y1="2" x2="16" y2="6" /></svg>
                        <span>Timetable</span>
                    </button>
                    <button className="sidebar-nav-item" onClick={() => navigate('/timetable-calc')}>
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="3" width="20" height="18" rx="2"/><line x1="8" y1="9" x2="16" y2="9"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="12" y2="17"/><path d="M16 17l1.5-3L19 17"/></svg>
